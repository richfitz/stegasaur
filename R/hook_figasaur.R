...
#'
#' Note that this only works for PNG files generated for HTML documents, though it does work when the PNGs are embedded in the HTML file (e.g. using the \code{self_contained} option in \code{\link[rmarkdown]{render}}. See \code{\link[knitr]{chunk_hook}} for more information.
#'
#' @export
